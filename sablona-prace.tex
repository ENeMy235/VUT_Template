...
\documentclass[%        Základní nastavení
    ...
    electronic,   			% Elektronické PDF - symetrické okraje (pro tisk zakomentujte tuto volbu)
    %electronicWithoutBlankPages,	% Potlačí vkládání prázdných stránek (hybridní číslování); vyžaduje volbu 'electronic'
...
%%
%% Definice zdrojů pro bibliografii
%% 
